...
public class RenderColoredRows implements RenderTableCellInfo
{
   ...
   public RenderColoredRows(List<TableCellColorSet> aColorScheme,TableCellColorIndexChooser aTest)
   {
      _scheme = aColorScheme;
      _colorIndexGetter = aTest;
   }

   public RenderColoredRows(List<TableCellColorSet> aColorScheme,TableCellColorIndexChooser aTest,Set<Integer> aColumns)
   {
      _scheme = aColorScheme;
      _colorIndexGetter = aTest;
      _columns = aColumns;
